...
* Запуск тестов в проекте происходит командой `pytest`, дополнительные параметры указывать не нужно - в проекте находится конфиг `pytest.ini`, который настраивает pytest.
